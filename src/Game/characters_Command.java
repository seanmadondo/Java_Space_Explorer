...
public class characters_Command
{
	...
	public boolean pilot_tired;
	public int actionCount;
	public boolean carry_plague;
	public boolean plague_immune;
	
	public characters_Command (String name, int health, int repair_skill, int search_skill, int hunger, boolean tired, int count, boolean plaue, boolean immune) 
	{
		pilot_name = name;
		pilot_health = health;
